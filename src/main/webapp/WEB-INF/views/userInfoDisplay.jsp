                   ...
                   <div class="span9 center margin-bottom"> 
					<h3>Enter Your Details</h3>
					  ...
					  <div class="control-group">
						...
						<div class="controls docs-input-sizes">
            				<form:input path="cart.userdetails.fullname" id="userFullName" class="form-Control"/>
						</div>
					  </div>
					  <div class="control-group">
						<label class="control-label">Email</label>
						<div class="controls docs-input-sizes">
						  <form:input path="cart.userdetails.email" id="userEmail" class="form-Control"/>
						</div>
					  </div>					  
					  <div class="control-group">
						<label class="control-label">Phone</label>
						<div class="controls docs-input-sizes">
						  <form:input path="cart.userdetails.contact" id="userPhone" class="form-Control"/>
						</div>
					  </div>					 
					...
					<legend>Billing Address </legend>
					 ...
					 <div class="control-group">
						...
						<div class="controls docs-input-sizes">
						 <form:input path="cart.userdetails.address" id="address" class="form-Control"/>
						</div>
					  </div>
