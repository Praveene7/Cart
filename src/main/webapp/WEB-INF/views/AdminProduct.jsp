...
<body>
	...
	<div class="container-fluid"
		style="background-color: black; color: gray; height: 80px;">
		<center>
			<h2>WELCOME ADMIN</h2>
		</center>
	</div>
	...
	<div class="row">
		...
		<ul class="nav nav-pills nav-stacked" data-offset-top="205">
			<li class="active"><a href="manageProducts">PRODUCT</a></li>
							...
							<c:choose>
								...
								<c:otherwise>
									...
									<td><form:input path="id" patttern=".{3,7}"
											required="true" title="id should contains 3 to 7 characters" />
								</c:otherwise>
